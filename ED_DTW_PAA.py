...
arraysB_ = np.array(PAA(arraysB, 30)).reshape(-1)
distance_, path_ = fastdtw(arraysA, arraysB, dist=euclidean)
...
ax[0].plot(arraysB,color='r',label='arraysB',alpha=0.75)
ax[1].plot(arraysB_,color='r',label='arraysB_',alpha=0.75)
